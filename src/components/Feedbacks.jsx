    ...
    <div className='mt-1'>
      ...
      <div className='mt-7 flex justify-between items-center gap-1'>
        <div className='flex-1 flex flex-col'>
          ...
          <p className='mt- text-secondary text-[12px]'>{designation} of {company}</p>
        </div>
        <img src={image} alt={`feedback-by-${name}}`} className='object-cover rounded-full w-10 h-10' />
      </div>
    </div>
  </motion.div>
)
...
const Feedbacks = () => {
  return (
    <div className='mt-12 bg-black-100 rounded-[20px]'>
      <div className={`${styles.padding} bg-tertiary rounded-2xl h-[300px]`}>
